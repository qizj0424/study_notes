 ...
 * if(ret){
 * 	printf("IMP_ISP_Tuning_SetMaskBlock error !\n");
 * 	return -1;
 * }
 * @endcode
 *
 ...
 * if(ret){
 * 	printf("IMP_ISP_Tuning_GetMaskBlock error !\n");
 * 	return -1;
 * }
 ...
 * if(ret){
 * 	printf("IMP_ISP_Tuning_GetOSDAttr error !\n");
 * 	return -1;
 * }
 ...
 * if(ret){
 * 	printf("IMP_ISP_Tuning_GetOSDBlock error !\n");
 * 	return -1;
 * }
 ...
 * if(ret){
 * 	printf("IMP_ISP_Tuning_GetDrawBlock error !\n");
 * 	return -1;
 * }
 ...
 * if(ret){
 * 	printf("IMP_ISP_Tuning_SwitchBin error !\n");
 * 	return -1;
 * }
 * @endcode
 *
